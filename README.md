...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:0f0c29,50:302b63,100:24243e&height=180&text=Pravin%20Kumar%20M&fontSize=48&fontColor=00D9FF&fontAlignY=45&desc=MERN%20Stack%20Developer%20%7C%20Full%20Stack%20Engineer%20%7C%20DSA%20Enthusiast&descSize=16&descColor=E0E0E0&descAlignY=70" width="100%"/>
...
<img src="https://img.shields.io/badge/REST_APIs-00D9FF?style=flat-square&logo=fastapi&logoColor=black" />
...
**Core Competencies:** Data Structures & Algorithms · DBMS · Object-Oriented Programming
...
### 🛒 ECommerce — Nxt Trendz
*Nov 2025*

Multi-page e-commerce app with Login, Product Listing, and Cart components. Built product search and category/rating filters using React Context for dynamic state management, with JWT-secured routes protecting sensitive pages via REST API calls.
...
```
Mar 2025  ●  Frontend Developer Intern — Nxt Wave CCBP 4.0 Academy (Remote, 1 Month)
             Developed and optimized responsive web pages using HTML, CSS, and Bootstrap,
             enhancing cross-device usability and improving rendering performance.
```
...
- 🧠 Sharpening DSA fundamentals and pushing past **280+ LeetCode** problems
- 🏗️ Building full-stack projects with production-grade auth, role-based access, and clean API design
- 🤖 Exploring AI agent workflows (Make.com, N8N) to automate repetitive tasks
- 🎯 Actively applying and interviewing for **full-time SDE roles**
- 📚 Deepening knowledge of system design and DBMS internals
...
<img src="https://capsule-render.vercel.app/api?type=rect&color=0:24243e,50:302b63,100:0f0c29&height=120&section=footer&text=Let's%20Build%20Something%20Great%20Together%20%F0%9F%9A%80&fontSize=20&fontColor=00D9FF&fontAlignY=55" width="100%"/>
